(function (global) {
  ...
  var STR = {
    en: {
      ...
      "unis.line": "Hover a school for a short look. Faded = this school does not teach this subject.",
      ...
      "unis.hover.p": "On a phone or iPad, tap a name. On a computer, point at it. You get a short intro and the official name for this subject. Faded chips do not teach this major.",
      ...
      "schools.lead": "Overseas Top-100 universities many Chinese international students pick. Search by name or country, then open a school to see official faculties and major names — not invented, not a ranking.",
      ...
      "nova.wake": "Ask Nova",
      "guide.home": "Press “Start with Nova”. Or press “Skip to the line map” if you want to pick likes yourself. Press anywhere to hear about Search.",
      "guide.homeSoft": "I can keep helping on the map. Turn me off anytime — I will stay quiet.",
      "guide.search": "Already know a major name? Press “Search for a major”. Even a misspelling can still find the right one. Or press anywhere to keep going.",
      ...
      "guide.facts": "Start with what you can try this year. Then read the specific major names under this station. Press anywhere for schools.",
      ...
      "guide.nextStation": "You can open another station anytime and compare two tickets. Press anywhere when you’re done.",
    ...
    zh: {
      ...
      "schools.lead": "QS 前 100 里、很多中国留学生会选的海外大学。按名字或国家搜索，点开学校看官方学院和专业名称——不是编造的，也不是排名。",
      "schools.label": "搜索大学",
      ...
      "nova.on": "打开 Nova",
      "nova.wake": "叫 Nova",
      "guide.home": "请按“从 Nova 开始”。如果想自己选兴趣，按“跳过，直接看线路图”。任意点一下，再听“搜索专业”。",
      "guide.homeSoft": "到线路图上我还会带路。随时可以关掉我，我不会吵你。",
      "guide.search": "已经知道专业名？请按“搜索专业”。拼错也可以，仍可能找到正确的专业。也可以任意点一下继续。",
      ...
      "guide.facts": "先看今年可以试什么，再看这个站点下的具体专业名。任意点一下，去看学校。",
      "guide.schools": "点一下校名，会有短介绍（电脑也可以把鼠标放上去）。变淡 = 官方不开设。看完任意点一下。",
      "guide.nextStation": "随时可以再按别的站点，对比两张车票。看完任意点一下。",
