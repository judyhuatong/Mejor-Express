(function (global) {
  ...
  var STR = {
    en: {
      ...
      "nav.home": "Home",
      "nav.search": "Search for a major",
      "nav.searchUnis": "Search universities",
      ...
      "meta.stationsVal": "25 stations",
      "meta.valid": "Valid",
      "meta.validVal": "Until you choose",
      catch: "Mejor, your major explorer.",
      sub: "You know what you like. You don’t yet know which university major that points to. This site maps your likes to 25 simple stations, then shows official major names at 15 universities — with a one-line meaning for age 14.",
      ...
      "gloss.major.p2": "This map has 25 simple stations. Open a station, then tap a school to see official major names under each faculty — written so a 14-year-old can understand.",
      "gloss.job.t": "Job",
      ...
      "line.make": "Make",
      "line.makeDef": "Buildings, art, sport",
      "cta.play": "Start with Nova",
      "cta.skip": "Skip to the line map",
      fine: "Keep this ticket. 25 stations. Not a forever job.",
      "card1.t": "01 · Answer a few questions",
      "card1.p": "Nova asks 20 school questions (from a bank of 200), then which subjects you like and where you already feel strong. Not an official test. Not a final stop.",
      "card2.t": "02 · Read the lines",
      "card2.p": "Matching majors light on four labeled lines. Each line has a colour and a meaning. Station names sit under the stops.",
      ...
      tagline: "Four lines. Twenty-five stations.",
      ...
      "brief.idle": "Tap a station on the lines, or a ticket in the list below.",
      ...
      "quiz.helloSoft": "I’ll ask 20 school questions — class, homework, labs — picked from a bank of 200. Then you choose subjects you like and subjects you’re strong at. You get 2–3 majors to look at. This is not a personality test, and not a final label.",
      "quiz.step1": "School. 20 A / B questions about class and homework, drawn from 200.",
      "quiz.step2": "Then subjects you like, then subjects you’re already strong at.",
      ...
      "result.soft": "This mixes how you work in class with subjects you like and subjects you’re strong at. It is not a final label.",
      ...
      "fact.specific": "Specific majors under this station",
      "fact.specific.p": "Official names you might study. Not every school uses every name. Twin titles like “with Year Abroad” are skipped.",
      ...
      "unis.line": "Hover a school for a short look. Faded = this school does not teach this major.",
      "catalog.t": "Official faculties and subjects (Aug 2026)",
      "catalog.note": "Official names. We skip twins like “with Year Abroad” — same subject, extra years. Not every joint-honours mix.",
      ...
      "unis.hover.p": "On a phone or iPad, tap a name. On a computer, point at it. You get a short intro and the official name for this major. Faded chips do not teach this major.",
      ...
      "country.USA": "USA",
      "title.home": "Mejor express",
      "title.explorer": "Mejor · Line map",
      "title.method": "Mejor · How this was made",
      "title.search": "Mejor · Search a major",
      "title.schools": "Mejor · Search universities",
      "meta.home": "Mejor maps what you like to 25 simple stations, then shows official major names at 15 universities with a meaning a 14-year-old can read. A first look — not a verdict.",
      ...
      "meta.method": "How Mejor’s match score, university set, and official major names were made. Honest limits, sources, and privacy.",
      "meta.search": "Search a university major even if you misspell it. Precise definition, what not to mix it up with, and which of 15 schools teach it.",
      "meta.schools": "Search 15 QS Top-100 overseas universities popular with Chinese international students. Official faculties and undergraduate major names.",
      "nav.method": "How this was made",
      "search.kicker": "Search station",
      "search.h1": "Don’t know the name? Look it up.",
      "search.lead": "Type a major even if you misspell it. Example: “chanical engineering” still finds Mechanical Engineering. You get a longer meaning, clear examples, what not to mix it up with, and which of these 15 schools teach it.",
      "search.label": "Search",
      "search.placeholder": "Try mechanical engineering, AI, or 心理学",
      "search.hint": "Typos are OK. Short names work: AI, mech eng, 心理学.",
      "search.results": "Matches",
      "search.none": "No match in this set. Try a shorter word, or open the line map.",
      "search.empty": "Pick a match on the left — or type a name above.",
      "search.station": "Map station",
      "search.major": "Official major",
      "search.simple": "Simple line (age 14)",
      "search.precise": "What it is (precise)",
      "search.examples": "Clear examples",
      "search.unlike": "Don’t mix it up with",
      "search.study": "What you study",
      "search.path": "Time and path",
      "search.under": "Official names under this station",
      "search.schools": "Schools in this set",
      "search.schools.n": "{n} of 15 list this official title.",
      "search.schools.none": "No school in this 15 uses this exact title.",
      "search.open": "Open this station on the map",
      "search.limit": "Not every Year Abroad twin. Not a full prospectus.",
      "schools.kicker": "University search",
      "schools.h1": "Browse the 15 schools",
      "schools.lead": "Overseas Top-100 universities many Chinese international students pick. Search by name or country — each result shows an overview, strengths, faculties, and official major names.",
      "schools.label": "Search universities",
      "schools.placeholder": "Try UCL, Melbourne, Toronto, King’s, or 伦敦",
      "schools.hint": "Short names work: NYU, UIUC, UNSW. You can also type a faculty or major name.",
      "schools.results": "Schools",
      "schools.none": "No school matches. Try a shorter name or a country: UK, Australia, Canada, USA.",
      "schools.loadFail": "Could not load the school list. Refresh the page, or open via python backend/server.py — not as a raw file.",
      "schools.faculties": "Official faculties",
      "schools.majors.n": "{n} official majors in this set",
      "schools.qs": "QS 2026",
      "schools.evidence": "Why Chinese students pick it",
      "schools.overview": "Overview",
      "schools.strengths": "Strengths in this set",
      "schools.lines": "Lines on the map",
      "schools.stats.fac": "{n} official faculties",
      "schools.shortName": "Also known as",
      "schools.subj.cs": "Computer Science",
      "schools.subj.eng": "Engineering",
      "schools.subj.stem": "Math, Physics & Data",
      "schools.subj.chem": "Chemistry",
      "schools.subj.env": "Environment & Earth",
      "schools.subj.med": "Medicine",
      "schools.subj.nurse": "Nursing",
      "schools.subj.dent": "Dentistry",
      "schools.subj.vet": "Veterinary Science",
      "schools.subj.pharm": "Pharmacy",
      "schools.subj.bio": "Life Sciences",
      "schools.subj.ph": "Public Health",
      "schools.subj.psy": "Psychology",
      "schools.subj.edu": "Education",
      "schools.subj.biz": "Business",
      "schools.subj.econ": "Economics",
      "schools.subj.law": "Law",
      "schools.subj.ir": "World & Public Policy",
      "schools.subj.lang": "Languages & Literature",
      "schools.subj.hist": "History",
      "schools.subj.social": "Social Work",
      "schools.subj.arch": "Architecture",
      "schools.subj.art": "Art, Design & Media",
      "schools.subj.music": "Music",
      "schools.subj.sport": "Sport & Movement",
      "schools.band.t": "Search the 15 universities",
      "schools.band.p": "Official faculties and major names at overseas Top-100 schools popular with Chinese international students.",
      ...
      "method.who.p": "Students aged 14–16 who know what they like — drawing, numbers, helping people — but cannot yet see which university major that points to. Parents and teachers can read along.",
      ...
      "method.backend.t": "Where the backend is",
      "method.backend.p": "FastAPI backend (backend/server.py): serves the site and JSON API. Docs at /api/docs. Routes: /api/v1/stats, /api/v1/majors, /api/v1/majors/{slug}, /api/v1/universities, /api/v1/search, /api/v1/quiz/draw. Catalog loads once at startup. No login database. Your likes stay only in this browser.",
      "method.schools.t": "Where the schools come from",
      "method.schools.p": "The same 15 universities (QS 2026 Top 100, plus Chinese-student notes). Tap a school to see official faculty names, then official major / subject names under each one, with a one-line meaning for age 14. We do not invent a faculty. We do not copy every course variant (UCL has 400+ titles, including Year Abroad twins). If a school does not teach a subject, it stays faded. Example: UIUC has no medical school.",
      ...
      "method.nova.p": "Nova asks 20 school questions drawn from a bank of 200 (how you work in class, not personality), then subjects you like versus subjects you’re strong at. The four-letter working-style code is a class label, not an official MBTI test. You can skip and choose likes yourself. On the map, Nova can keep pointing where to press. You can turn Nova off if that feels noisy. You can change likes at any time.",
      ...
      "method.privacy.p": "No account. No login database. Language, likes, the open station, and whether Nova is guiding are saved in this browser only (localStorage). An optional FastAPI backend (backend/server.py) can serve the same catalog if you self-host — your likes still stay local. Clearing the site data clears your ticket.",
      "method.cta": "Open the line map",
      "nova.off": "Turn Nova off",
      "nova.on": "Turn Nova on",
      "nova.wake": "Ask Nova",
      "guide.home": "1 · Start with Nova. Twenty school questions, then what you like and what you’re strong at.",
      "guide.homeSoft": "I can keep helping on the map. Turn me off anytime — I will stay quiet.",
      "guide.search": "2 · Search for a major by name — even a misspelling can work.",
      "guide.searchUnis": "3 · Search universities. Browse all 15 schools with faculties and official major names.",
      "guide.homeLuck": "That’s the tour. Good luck — take 2–3 names home and tell someone. First look, not a verdict.",
      "guide.tour.unis": "1 · Search universities. All 15 schools, with strengths, faculties, and official majors.",
      "guide.tour.likes": "2 · Choose up to 4 likes. Matching stations turn green or gold.",
      "guide.tour.lines": "3 · Tap a bright station to open a ticket.",
      "guide.tour.search": "4 · Search for a major anytime from here.",
      "guide.tour.luck": "That’s the map tour. Good luck exploring — take 2–3 names home.",
      "guide.station.searchUnis": "5 · Browse all 15 schools anytime.",
      "guide.station.search": "6 · Search for a major by name.",
      "guide.searchs": "You get a precise definition, what not to mix it up with, and which schools teach it.",
      ...
      "guide.likesMore": "Good. You can pick up to 4. When you are ready, press a green or gold station on the lines.",
      "guide.likesMores": "The stops sit on Logic, Care, World, and Make. Grey ones are weaker matches.",
      "guide.likesFull": "That’s 4 likes. Now press a bright station on the lines to open a ticket.",
      ...
      "guide.open": "1 · This is the station ticket. Green = strong match. Gold = partial. Faded schools do not teach this major here.",
      "guide.opens": "Faded schools do not officially teach this major. That is honest, not a bug.",
      "guide.match": "2 · The % is how many of YOUR likes this station covers.",
      "guide.facts": "3 · What you can try this year, and the official major names under this station.",
      "guide.schools": "4 · Tap a school for a short intro. Faded = not taught here.",
      "guide.nextStation": "7 · Open another station anytime to compare two tickets.",
      "guide.luck": "Good luck on {name}. Keep 2–3 names. Tell someone. Not a forever job.",
      "guide.luck.path": "your search",
      "guide.tap": "Tap anywhere for the next stop.",
      "guide.tapNext": "Tap anywhere for the next stop.",
      ...
      "guide.where.lines": "Press here: a station",
      ...
      "guide.where.next": "Press here: another station",
      "guide.where.luck": "Good luck",
      "guide.where.quiz": "Press here: A or B",
      "guide.skip": "4 · Or skip to the line map and pick likes yourself.",
      "guide.where.skip": "Press here: Skip to the line map",
      "guide.where.search": "Press here: Search for a major",
      "guide.where.searchUnis": "Press here: Search universities",
    ...
    zh: {
      ...
      "meta.classVal": "初探",
      "meta.stations": "站点",
      "meta.stationsVal": "25 个站点",
      "meta.valid": "有效期",
      "meta.validVal": "直到你选定",
      catch: "Mejor，你的专业探索器。",
      sub: "你知道自己喜欢什么，但还不知道那会通向哪个大学专业。这个网站把兴趣对应到 25 个简单站点，再列出 15 所大学的官方专业名称——每条都有一句 14 岁也能懂的解释。",
      purpose: "你会带走 2–3 个值得再看的专业——不是一份工作，不是一辈子的计划，也不是给你打分。",
      "gloss.major.t": "专业",
      "gloss.major.p": "大学里学的科目方向，比如计算机科学、心理学、建筑学。它是一条学习路径，不是职位名称，也不是一辈子的标签。",
      "gloss.major.p2": "图上有 25 个简单站点。打开站点，再点学校，可以看到每个学院下面的官方专业名称——用 14 岁也能懂的一句话解释。",
      "gloss.job.t": "工作",
      ...
      "line.make": "创造",
      "line.makeDef": "建筑、艺术、运动",
      "cta.play": "从 Nova 开始",
      "cta.skip": "跳过，直接看线路图",
      fine: "请保留车票。25 个站点。选专业不是定终身。",
      "card1.t": "01 · 先答几道题",
      "card1.p": "Nova 会问 20 道学校题（从 200 道题库里抽），再问你喜欢哪些科目、已经擅长哪些。不是正式测验，也不是终点站。",
      "card2.t": "02 · 看线路",
      "card2.p": "匹配的专业会在四条有名字的线路上亮起来。每条线有颜色和含义。站名写在圆点下面。",
      "card3.t": "03 · 打开站点",
      ...
      "quiz.helloSoft": "我会问 20 道学校题——课堂、作业、实验——从 200 道题库里抽出。然后你选喜欢的科目，再选已经擅长的科目。最后得到 2–3 个可以再看的专业。这不是性格测试，也不是最终标签。",
      "quiz.step1": "学校。20 道 A / B 题，关于上课和作业，从 200 道里抽。",
      "quiz.step2": "然后选你喜欢的科目，再选你已经擅长的科目。",
      ...
      "result.soft": "这把你在课堂上的做事方式、喜欢的科目和擅长的科目合在一起。不是最终标签。",
      "result.like": "你喜欢",
      "result.strong": "你擅长",
      ...
      "fact.unlike": "别和它搞混",
      "fact.now": "今年可以试什么",
      "fact.specific": "这个站点下的具体专业",
      "fact.specific.p": "你可能读到的官方专业名。不是每所学校都用每一个名字。像“海外一年”这类双胞胎课程不列。",
      "fact.watch": "老实话",
      "unis.top": "15 所学校都会出现。变淡的校名表示官方不开设这个专业。",
      "unis.set": "点一下校名。变淡 = 这所学校在这里官方不开设这个专业。",
      "unis.line": "把鼠标放到校名上看一眼。变淡 = 这所学校不开这个专业。",
      "catalog.t": "官方学院和专业（2026年8月）",
      "catalog.note": "官方名称。我们不抄“海外一年”这类双胞胎课程——同一专业，只是多一年。也不列每一个联合学位组合。",
      "catalog.subjects": "专业",
      "unis.qs.t": "QS 数字",
      ...
      "unis.hover.p": "手机或平板请点校名；电脑可以把鼠标放上去。会看到一句简介，以及这个专业的官方名称。变淡的芯片表示不开设这个专业。",
      ...
      "title.search": "Mejor · 搜索专业",
      "title.schools": "Mejor · 搜索大学",
      "meta.home": "Mejor 把你的兴趣对应到 25 个简单站点，再列出 15 所大学的官方专业名称，每条都有 14 岁也能懂的解释。初探——不是定论。",
      "meta.explorer": "选出兴趣，看匹配专业在四条线路上亮起来，打开站点读它是什么、哪些大学真正教。",
      "meta.method": "Mejor 的匹配百分比、学校名单和官方专业名称是怎么来的。诚实的界限、来源和隐私。",
      "meta.search": "就算拼错也能搜大学专业。更准确的定义、别和谁搞混，以及这 15 所学校里谁教。",
      "meta.schools": "搜索 15 所 QS 前 100 海外大学——很多中国留学生会选。官方学院与本科专业名称。",
      "nav.method": "这是怎么做的",
      "search.kicker": "搜索站",
      "search.h1": "不知道名字？搜一下。",
      "search.lead": "就算拼错也可以搜。例如输入 chanical engineering，仍会找到机械工程。你会看到更细的说明、清楚的例子、别和谁搞混，以及这 15 所学校里谁教。",
      "search.label": "搜索",
      "search.placeholder": "试试 mechanical engineering、AI，或心理学",
      "search.hint": "拼错没关系。简称也可以：AI、mech eng、心理学。",
      "search.results": "匹配结果",
      "search.none": "这组名单里没有匹配。试试更短的词，或打开线路图。",
      "search.empty": "在左边点一条结果——或在上面输入名称。",
      "search.station": "地图站点",
      "search.major": "官方专业",
      "search.simple": "给 14 岁的一句话",
      "search.precise": "它到底是什么",
      "search.examples": "清楚的例子",
      "search.unlike": "别和它搞混",
      "search.study": "学什么",
      "search.path": "时间和路径",
      "search.under": "这个站点下的官方名称",
      "search.schools": "这组名单里的学校",
      "search.schools.n": "15 所里有 {n} 所列出这个官方名称。",
      "search.schools.none": "这 15 所学校没有用这个准确名称开设。",
      "search.open": "在线路图打开这个站点",
      "search.limit": "不列每一个海外一年双胞胎。也不是完整招生手册。",
      "schools.kicker": "大学搜索",
      "schools.h1": "浏览这 15 所学校",
      "schools.lead": "QS 前 100 里、很多中国留学生会选的海外大学。按名字或国家搜索——每个结果包含简介、强项、学院和官方专业名称。",
      "schools.label": "搜索大学",
      "schools.placeholder": "试试 UCL、Melbourne、Toronto、King’s，或伦敦",
      "schools.hint": "简称也可以：NYU、UIUC、UNSW。也可以输入学院或专业名。",
      "schools.results": "学校",
      "schools.none": "没有匹配的学校。试试更短的名字，或国家：UK、Australia、Canada、USA。",
      "schools.loadFail": "学校列表加载失败。请刷新页面，或通过 python backend/server.py 打开——不要直接双击 html 文件。",
      "schools.faculties": "官方学院",
      "schools.majors.n": "这份名单里有 {n} 个官方专业",
      "schools.qs": "QS 2026",
      "schools.evidence": "为什么很多中国学生选它",
      "schools.overview": "学校简介",
      "schools.strengths": "这份名单里的强项",
      "schools.lines": "对应四条线路",
      "schools.stats.fac": "{n} 个官方学院",
      "schools.shortName": "简称",
      "schools.subj.cs": "计算机科学",
      "schools.subj.eng": "工程",
      "schools.subj.stem": "数学、物理与数据",
      "schools.subj.chem": "化学",
      "schools.subj.env": "环境与地球",
      "schools.subj.med": "医学",
      "schools.subj.nurse": "护理",
      "schools.subj.dent": "牙科",
      "schools.subj.vet": "兽医",
      "schools.subj.pharm": "药学",
      "schools.subj.bio": "生命科学",
      "schools.subj.ph": "公共卫生",
      "schools.subj.psy": "心理学",
      "schools.subj.edu": "教育学",
      "schools.subj.biz": "商科",
      "schools.subj.econ": "经济学",
      "schools.subj.law": "法学",
      "schools.subj.ir": "世界与公共政策",
      "schools.subj.lang": "语言与文学",
      "schools.subj.hist": "历史",
      "schools.subj.social": "社会工作",
      "schools.subj.arch": "建筑",
      "schools.subj.art": "艺术、设计与媒体",
      "schools.subj.music": "音乐",
      "schools.subj.sport": "运动与体育",
      "schools.band.t": "搜索这 15 所大学",
      "schools.band.p": "QS 前 100 海外大学里，很多中国留学生会选的学校——官方学院与专业名称。",
      skip: "跳到正文",
      updated: "更新于 2026年8月27日",
      ...
      "method.who.t": "给谁用",
      "method.who.p": "14 到 16 岁、知道自己喜欢什么——画画、数字、帮助别人——但还看不清那会通向哪个大学专业的学生。家长和老师可以一起看。",
      ...
      "method.backend.t": "后端在哪",
      "method.backend.p": "FastAPI 后端（backend/server.py）：同时提供网页和 JSON API。文档在 /api/docs。接口：/api/v1/stats、/api/v1/majors、/api/v1/majors/{slug}、/api/v1/universities、/api/v1/search、/api/v1/quiz/draw。启动时加载一次目录。没有登录数据库。你点的兴趣仍只存在浏览器里。",
      "method.schools.t": "学校从哪来",
      "method.schools.p": "还是这 15 所大学（QS 2026 前 100，加上中国学生情况）。点学校可以看到官方学院，再看到每个学院下面的官方专业名称，并用一句话给 14 岁解释。我们不编造学院。我们也不抄每一个课程变体（UCL 有 400 多个名称，包括“海外一年”双胞胎）。如果某校不开某专业，它仍变淡。例如：这里的 UIUC 没有医学院。",
      ...
      "method.nova.p": "Nova 会从 200 道题库里抽出 20 道学校题（关于你怎么上课，不是性格），再问喜欢的科目和擅长的科目。四个字母的工作风格是课堂标签，不是正式 MBTI 测验。你可以跳过，自己选兴趣。在线路图上，Nova 可以一直提示该按哪里。觉得吵可以关掉。随时能改兴趣。",
      "method.not.t": "这不是什么",
      "method.not.p": "不是职位名称。不是一辈子的计划。不是“最好的大学”。QS 数字是世界排名，不是适不适合你。一个专业可以通向很多工作，工作也会变。",
      "method.privacy.t": "隐私",
      "method.privacy.p": "没有账号，没有登录数据库。语言、兴趣、打开的站点，以及 Nova 开或关，只存在这个浏览器里（localStorage）。可选的 FastAPI 后端（backend/server.py）可以自托管同一套目录——兴趣仍只保存在本地。清除网站数据就会清掉车票。",
      "method.cta": "打开线路图",
      "nova.off": "关掉 Nova",
      "nova.on": "打开 Nova",
      "nova.wake": "叫 Nova",
      "guide.home": "1 · 请按“从 Nova 开始”。二十道学校题，再问喜欢什么、擅长什么。",
      "guide.homeSoft": "到线路图上我还会带路。随时可以关掉我，我不会吵你。",
      "guide.search": "2 · 搜索专业名——拼错也可能找到。",
      "guide.searchUnis": "3 · 搜索大学。浏览全部 15 所学校、学院和官方专业名。",
      "guide.homeLuck": "全程讲完了。祝顺利——带走两三个名字，告诉一个人。只是初探，不是定论。",
      "guide.tour.unis": "1 · 搜索大学。15 所学校，含强项、学院和官方专业名。",
      "guide.tour.likes": "2 · 最多选 4 个兴趣。匹配的站点会变绿或金。",
      "guide.tour.lines": "3 · 点一个较亮的站点，打开车票。",
      "guide.tour.search": "4 · 随时可以从这里搜索专业。",
      "guide.tour.luck": "线路图全程讲完了。祝探索顺利——带走两三个名字。",
      "guide.station.searchUnis": "5 · 随时可浏览全部 15 所大学。",
      "guide.station.search": "6 · 随时可搜索专业名。",
      "guide.searchs": "你会看到准确的定义、不要和什么搞混，以及哪些学校开设。",
      "guide.likes0": "请按一张兴趣卡片——在“选出你喜欢的”下面，带图标的那些。先选一件你喜欢的事。",
      "guide.likes0s": "选中后卡片会翻面。线路上匹配的站点会变成绿色或金色。",
      "guide.likesMore": "很好。最多可以选 4 个。准备好了，就去按线路上绿色或金色的站点。",
      "guide.likesMores": "站点在逻辑、关怀、世界、创造四条线上。灰色的是较弱的匹配。",
      "guide.likesFull": "已经 4 个兴趣了。现在请按线路上较亮的站点，打开一张车票。",
      "guide.likesFulls": "再点一次已选的卡片，可以取消，再换一个。",
      "guide.peek": "你在先看看这个站点。请先按上面的兴趣卡片，线路才会亮起来。",
      "guide.peeks": "亮起来之后，右边的说明会更好懂。",
      "guide.open": "1 · 这是站点车票。绿色 = 较强匹配，金色 = 部分匹配。变淡的学校在这里官方不开。",
      "guide.opens": "变淡的学校官方不开设这个专业。这是实话，不是故障。",
      "guide.match": "2 · 百分比 = 这个站点覆盖了你几个兴趣。",
      "guide.facts": "3 · 今年可以试什么，以及这个站点下的官方专业名。",
      "guide.schools": "4 · 点校名看短介绍。变淡 = 官方不开。",
      "guide.nextStation": "7 · 随时可以再开一个站点，对比两张车票。",
      "guide.luck": "祝你在{name}这条路上顺利。留下两三个名字。告诉一个人。不是一辈子的工作。",
      "guide.luck.path": "你的探索",
      "guide.tap": "任意点一下，下一站。",
      "guide.tapNext": "任意点一下，下一站。",
      "guide.quiz": "请在卡片里按 A 或 B。没有对错。也可以跳过，自己选兴趣。",
      "guide.quizs": "问完我会在线路图上等你。",
      "guide.where.likes": "请按这里：兴趣卡片",
      "guide.where.lines": "请按这里：一个站点",
      "guide.where.brief": "请看这里：站点车票",
      "guide.where.match": "请看这里：匹配百分比",
      "guide.where.facts": "请看这里：今年可以试什么",
      "guide.where.schools": "请点这里：校名",
      "guide.where.next": "请按这里：另一个站点",
      "guide.where.luck": "祝顺利",
      "guide.where.quiz": "请按这里：A 或 B",
      "guide.skip": "4 · 或者跳过测验，直接到线路图自己选兴趣。",
      "guide.where.skip": "请按这里：跳过，直接看线路图",
      "guide.where.search": "请按这里：搜索专业",
      "guide.where.searchUnis": "请按这里：搜索大学",
  ...
  var DATA = {
    ...
    majors: {
      ...
      lang: {
        name: "语言与故事",
        blurb: "你学语言、书本，以及怎样把想法说清楚。",
        learn: "阅读、写作、别的语言，还有不同地方的故事。",
        need: "喜欢文字，句子很难时也有耐心。",
        future: "写作、翻译、教书，或跟其他国家的人一起工作。"
      },
      hist: {
        name: "历史与思想",
        blurb: "你研究过去的人做了什么，以及他们相信什么。",
        learn: "历史、哲学，以及用证据，而不只凭感觉。",
        need: "仔细阅读，爱问“我们怎么知道的？”",
        future: "研究助手、博物馆、教书，或读政策材料。"
      },
      chem: {
        name: "化学",
        blurb: "你研究东西是由什么组成的，以及它怎样变化。",
        learn: "原子、反应、实验室安全，以及材料为什么会那样。",
        need: "实验时手要稳，不怕小步骤。",
        future: "实验室、以后读医、材料，或食品科学。"
      },
      env: {
        name: "地球与环境",
        blurb: "你研究地球：天气、海洋、土地，以及怎样保护它。",
        learn: "地理、气候、森林、水和关于地球的简单数据。",
        need: "喜欢户外或地图，并且关心地球。",
        future: "环境工作、地理、海洋科学，或以后的城市规划。"
      },
      nurse: {
        name: "护理",
        blurb: "你学习每天照顾病人，并且和团队一起工作。",
        learn: "人体、照顾技能，以及病房怎样运转。",
        need: "善良、扛得住，别人害怕时你能保持冷静。",
        future: "护士。这是一条真实的工作路。很累，但真的在帮人。"
      },
      dent: {
        name: "牙科",
        blurb: "你学习照顾牙齿和口腔。",
        learn: "口腔、很细的手部技能，以及怎样让牙齿保持健康。",
        need: "手要稳，不怕靠近别人工作。",
        future: "牙医。训练时间很长。"
      },
      vet: {
        name: "兽医",
        blurb: "你学习照顾生病或受伤的动物。",
        learn: "动物的身体、诊所，以及宠物或农场动物护理。",
        need: "喜欢动物，也要学科学。动物会痛，你要扛得住。",
        future: "兽医。竞争很强，路也很长。"
      },
      pharm: {
        name: "药学",
        blurb: "你学习药怎样起作用，以及怎样安全给药。",
        learn: "药物化学、人体，以及仔细核对。",
        need: "很小心。药搞错是大事。",
        future: "药店或医院的药剂师。"
      },
      music: {
        name: "音乐",
        blurb: "你练习乐器或唱歌，并学习音乐是怎样组成的。",
        learn: "演奏、听，有时也写曲子。",
        need: "每天练习。天赋有用，但时间更重要。",
        future: "演出、教书，或在录音棚和舞台工作。"
      },
      sport: {
        name: "运动与身体",
        blurb: "你研究身体怎样运动、训练和变强。",
        learn: "运动科学、训练想法，以及肌肉怎样工作。",
        need: "喜欢运动，也要一点科学。",
        future: "教练、以后的物理治疗、体育老师，或运动科学。"
      },
      social: {
        name: "社会工作",
        blurb: "你在生活很难的时候，帮助家庭和社区。",
        learn: "倾听、保护相关的法律，以及怎样安全地支持别人。",
        need: "耐心，心要够强。有些故事会很沉。",
        future: "社工、青少年工作，或社区助手。"
      }
    },
    quiz: [],
    novaLead: [
    ...
    extra: {
      ...
      lang: {
        mean: "语言、书本，以及怎样把想法说清楚。",
        unlike: "不是历史（用证据看过去），也不是世界与政策（国家和权力）。这条先看文字。",
        now: "为了好玩去读书。试一个语言 App。写一个短故事。",
        watch: "阅读会很多。现在不必完美。"
      },
      hist: {
        mean: "过去发生了什么，以及人们相信什么。",
        unlike: "不是语言（故事和语法），也不是法学（今天的规则）。",
        now: "看历史视频时问：「我们怎么知道的？」",
        watch: "要写作文。证据比酷酷的观点更重要。"
      },
      chem: {
        mean: "东西是由什么组成的，以及它在实验室里怎样变化。",
        unlike: "不是生命科学（先看活的东西），也不是工程（造机器）。",
        now: "学校化学社，或做饭时注意热会带来什么变化。",
        watch: "要遵守实验室规则。也有一点数学。"
      },
      env: {
        mean: "地球：土地、水、天气，以及怎样保护它。",
        unlike: "不是生命科学（近看细胞和动物），也不是建筑（设计房子）。",
        now: "带着地图散步。环保社。看一则气候新闻。",
        watch: "科学和数据都会有。有时在户外，有时在书桌前。"
      },
      nurse: {
        mean: "每天照顾病人，并且和团队一起工作。",
        unlike: "不是医学（医生那条路），也不是公共卫生（整座城市）。护理是动手照顾。",
        now: "学急救。如果年龄允许，去做志愿。",
        watch: "要轮班，脚会酸，情绪也会重。但这是一条清楚的工作路。"
      },
      dent: {
        mean: "牙齿和口腔。",
        unlike: "不是医学（整个身体），也不是护理（病房照顾）。",
        now: "照顾好自己的牙。科学和细手工（做模型）都有帮助。",
        watch: "训练很长。手要稳。"
      },
      vet: {
        mean: "生病或受伤的动物。",
        unlike: "不是生命科学（实验室），也不是医学（人）。",
        now: "如果能温柔、安全地照顾动物，就去做。学生物。",
        watch: "竞争很强。有开心的日子，也有难过的日子。"
      },
      pharm: {
        mean: "药怎样起作用，以及怎样安全给药。",
        unlike: "不是化学（所有材料），也不是医学（给人生病下判断）。",
        now: "学化学。和家长一起读药盒上的说明。",
        watch: "细节很重要。搞混会很危险。"
      },
      music: {
        mean: "把演奏、唱歌或写曲子当成主科。",
        unlike: "不是艺术与媒体（先看图画和电影）。音乐需要每天练习。",
        now: "每天练 15 分钟。参加合唱或乐队。",
        watch: "会有试镜和作品集。练的时间比只靠天赋更重要。"
      },
      sport: {
        mean: "身体怎样运动、训练和变强。",
        unlike: "不是医学，也不是护理。这条是运动和训练的科学。",
        now: "参加校队，或记录自己一个月的训练。",
        watch: "还是要学科学。喜欢运动，不等于已经懂这门课。"
      },
      social: {
        mean: "在生活很难的时候，帮助家庭和社区。",
        unlike: "不是心理学（实验室里的大脑），也不是教育学（教室）。",
        now: "好好听别人说话。参加友善的社团。问辅导员这份工作真正是什么样。",
        watch: "故事会很沉。你需要大人在旁边支持你。"
      }
    }
  };
  ...
  function novaFaceSvg(suf) {
    suf = suf || "";
    function gid(n) { return "nv-" + n + suf; }
    return [
      '<svg class="nova-svg" viewBox="0 0 72 84" fill="none" xmlns="http://www.w3.org/2000/svg">',
      "<defs>",
      '<linearGradient id="' + gid("body") + '" x1="18" y1="18" x2="54" y2="70" gradientUnits="userSpaceOnUse">',
      '<stop stop-color="#fff9f0"/><stop offset="1" stop-color="#d8cfc0"/>',
      "</linearGradient>",
      '<linearGradient id="' + gid("screen") + '" x1="22" y1="24" x2="50" y2="44" gradientUnits="userSpaceOnUse">',
      '<stop stop-color="#1a2824"/><stop offset="1" stop-color="#0c1110"/>',
      "</linearGradient>",
      '<radialGradient id="' + gid("glow") + '" cx="36" cy="33" r="16" gradientUnits="userSpaceOnUse">',
      '<stop stop-color="#3d8f78" stop-opacity=".35"/><stop offset="1" stop-opacity="0"/>',
      "</radialGradient>",
      '<linearGradient id="' + gid("beacon") + '" x1="33" y1="1" x2="39" y2="9" gradientUnits="userSpaceOnUse">',
      '<stop stop-color="#d4a85a"/><stop offset="1" stop-color="#3d8f78"/>',
      "</linearGradient>",
      "</defs>",
      '<ellipse class="nova-floor" cx="36" cy="80" rx="17" ry="3.2" fill="#0c1110" opacity=".22"/>',
      '<ellipse cx="36" cy="42" rx="27" ry="29" stroke="#3d8f78" stroke-width=".75" stroke-opacity=".2" stroke-dasharray="2.5 3.5"/>',
      '<g class="nova-rig">',
      '<line x1="36" y1="17" x2="36" y2="7.5" stroke="#1a1a18" stroke-width="1.35" stroke-linecap="round"/>',
      '<rect x="32.1" y="1.2" width="7.8" height="7.8" rx="1.1" transform="rotate(45 36 5.1)" fill="url(#' + gid("beacon") + ')" stroke="#1a1a18" stroke-width=".85"/>',
      '<rect x="14.5" y="17.5" width="43" height="47" rx="15.5" fill="url(#' + gid("body") + ')" stroke="#1a1a18" stroke-width="1.45"/>',
      '<rect x="19.5" y="52.5" width="7.5" height="2.8" rx="1" fill="#3d8f78"/>',
      '<rect x="28.5" y="52.5" width="7.5" height="2.8" rx="1" fill="#5aa3b0"/>',
      '<rect x="37.5" y="52.5" width="7.5" height="2.8" rx="1" fill="#d4a85a"/>',
      '<rect x="46.5" y="52.5" width="6" height="2.8" rx="1" fill="#d07a62"/>',
      '<rect x="19.5" y="23.5" width="33" height="23" rx="7.5" fill="url(#' + gid("screen") + ')" stroke="#3d8f78" stroke-width="1.15"/>',
      '<rect x="19.5" y="23.5" width="33" height="23" rx="7.5" fill="url(#' + gid("glow") + ')"/>',
      '<circle class="eye" cx="28.5" cy="32.5" r="3" fill="#3d8f78"/>',
      '<circle class="eye" cx="43.5" cy="32.5" r="3" fill="#3d8f78"/>',
      '<circle cx="27.6" cy="31.5" r="1" fill="#e8f7f1"/>',
      '<circle cx="42.6" cy="31.5" r="1" fill="#e8f7f1"/>',
      '<path class="nova-smile" d="M27.5 40.5 Q36 44.5 44.5 40.5" stroke="#5aa3b0" stroke-width="1.35" stroke-linecap="round" fill="none" opacity=".9"/>',
      '<rect x="23.5" y="63.5" width="7" height="4.5" rx="2" fill="#c5bcae" stroke="#1a1a18" stroke-width=".95"/>',
      '<rect x="41.5" y="63.5" width="7" height="4.5" rx="2" fill="#c5bcae" stroke="#1a1a18" stroke-width=".95"/>',
      "</g>",
      "</svg>"
    ].join("");
  }
  function novaBotSvg() {
    return '<div class="nova-bot" aria-hidden="true">' + novaFaceSvg("fly") + "</div>";
  }
  function novaEnsure() {
  ...
  if (!document.getElementById("mejor-flip-css")) {
    ...
    css.textContent = [
      "html,body,button,input,select,textarea,.nova-wake,#novaFlyer,.nova-guide{font-family:Manrope,'Noto Sans SC',sans-serif;}",
  ...
  if (!document.getElementById("mejor-nova-css")) {
    ...
    novaCss.textContent = [
      ...
      ".nova-wake{position:fixed;left:16px;bottom:16px;z-index:80;appearance:none;cursor:pointer;font:inherit;font-weight:700;font-size:.85rem;border:1.5px solid rgba(61,143,120,.65);background:rgba(12,17,16,.92);color:#efe4cc;padding:10px 14px;border-radius:999px;box-shadow:0 8px 28px rgba(0,0,0,.35),0 0 0 1px rgba(239,228,204,.08);backdrop-filter:blur(8px);}",
      ".nova-wake:hover{background:rgba(26,40,36,.96);border-color:#3d8f78;}",
      "#novaFlyer{position:fixed;z-index:70;width:72px;height:84px;overflow:visible;pointer-events:none;perspective:520px;}",
      "#novaFlyer .nova-bot{position:relative;width:72px;height:84px;overflow:visible;pointer-events:auto;cursor:pointer;transform-style:preserve-3d;transform:rotateY(-12deg) rotateX(6deg) translateZ(6px);transform-origin:50% 78%;animation:mejorNova3d 5.2s ease-in-out infinite;filter:drop-shadow(0 10px 18px rgba(12,17,16,.45)) drop-shadow(0 0 12px rgba(61,143,120,.25));}",
      "#novaFlyer .nova-bot::after{content:'';position:absolute;left:50%;top:50%;width:58px;height:58px;margin:-29px 0 0 -29px;border-radius:50%;border:1px solid rgba(61,143,120,.18);animation:mejorNovaRing 6s linear infinite;pointer-events:none;}",
      ...
      "@keyframes mejorNova3d{0%,100%{transform:rotateY(-14deg) rotateX(7deg) translateY(0) translateZ(6px)}50%{transform:rotateY(12deg) rotateX(5deg) translateY(-8px) translateZ(10px)}}",
      "@keyframes mejorNovaRing{0%{transform:rotate(0deg) scale(.92);opacity:.35}50%{opacity:.65}100%{transform:rotate(360deg) scale(1.04);opacity:.35}}",
      "#novaFlyer .nova-say{pointer-events:auto;cursor:pointer;position:absolute;bottom:calc(100% + 10px);left:50%;transform:translateX(-50%);width:max-content;max-width:min(260px,calc(100vw - 24px));box-sizing:border-box;background:rgba(244,234,214,.97);color:#1a1a18;border:1.5px solid rgba(61,143,120,.45);border-left:4px solid #3d8f78;border-radius:10px;padding:11px 13px;overflow-wrap:anywhere;box-shadow:0 10px 28px rgba(12,17,16,.22);backdrop-filter:blur(6px);}",
      "#novaFlyer.say-below .nova-say{bottom:auto;top:calc(100% + 8px);}",
      "#novaFlyer.say-left .nova-say{left:auto;right:0;transform:none;}",
      "#novaFlyer .nova-say b{display:block;font-size:.64rem;letter-spacing:.12em;text-transform:uppercase;color:#3d8f78;margin-bottom:3px;}",
      ...
      "#novaFlyer .nova-say .where{margin-top:5px;font-size:.72rem;font-weight:700;letter-spacing:.05em;text-transform:uppercase;color:#d4a85a;}",
      "html[lang='zh-Hans'] #novaFlyer .nova-say .where{letter-spacing:.02em;text-transform:none;}",
      "#novaFlyer .nova-quiet{pointer-events:auto;margin-top:6px;appearance:none;cursor:pointer;font:inherit;font-size:.72rem;font-weight:700;border:1px solid rgba(26,26,24,.35);border-radius:999px;background:#fff;color:#1a1a18;padding:4px 10px;}",
      "#novaFlyer .nova-quiet:hover{background:#e8f3ef;border-color:#3d8f78;}",
      ...
      "@media (prefers-reduced-motion:reduce){#novaFlyer .eye,#novaGlowBox,#novaFlyer .nova-bot::after{animation:none!important}#novaFlyer .nova-bot,.nova.nova-3d{animation:none!important;transform:rotateY(-10deg) rotateX(6deg)}}",
